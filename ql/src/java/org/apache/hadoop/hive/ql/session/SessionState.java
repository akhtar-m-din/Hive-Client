...
import com.sherpa.core.bl.WorkloadIdGenerator;
import com.sherpa.tunecore.joblauncher.com.sherpa.tunecore.joblauncher.hivecli.HiveCliJobIdExtractor;
...
public class SessionState {
  ...
  */
  ...
  public static class LogHelper {
    ...
    protected Log LOG;
    protected boolean isSilent;
    private HiveCliJobIdExtractor hiveCliJobIdExtractor = new HiveCliJobIdExtractor();
    ...
    public void printInfo(String info) {
      if(hiveCliJobIdExtractor!=null) {
          hiveCliJobIdExtractor.extractJobIdFromLogLine(info);
      }
      printInfo(info, null);
    }
    ...
    public void printInfo(String info, String detail) {
      ...
      LOG.info("Sherpa Log: " +info + StringUtils.defaultString(detail));
    }
